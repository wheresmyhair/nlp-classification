#### SUMMARY ####
# Description: Transformer Encoder as a classification model

# INPUT: torch.tensor
# DIM: (batch_size, max_seq_len) 
# The input comes from the result of tokenizer.
# If the seq_len is less than max_seq_len, 
# the rest of the tensor will be padded, idx depends on the padding_idx

# OUTPUT: torch.tensor
# DIM: (batch_size, num_cls)
#################
import numpy as np
import torch
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, vocab_size, seq_len, num_cls, d_model=512, n_layers=6, n_heads=8, p_drop=0.1, d_ff=2048, pad_id=0):
        ...
        # layers for classification output
        self.linear = nn.Linear(d_model, num_cls)
...
# emb = nn.Embedding(2000, 4, padding_idx=0)
# k = torch.tensor(
#     [[1123,134,0], 
#      [113,0,0]]
# )
# emb(k)
# tsfm = TransformerEncoder(
#     vocab_size=2000,
#     seq_len=3,
#     d_model=4,
#     n_layers=6,
